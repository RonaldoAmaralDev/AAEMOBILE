package com.delaroystudios.uploadmedia.operacao.os;
...
public class MainActivityOS  extends AppCompatActivity  {
    ...
    private String equipamento_id, local_id, centrolucro_id;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Toolbar toolbar = findViewById(R.id.toolbaros);
        ...
        getSupportActionBar().setTitle(R.string.toolbar_titleOS);

        RecyclerView recyclerView = findViewById(R.id.recycler_viewos);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        searchView.setOnQueryTextListener(new SearchView.OnQueryTextListener() {
            ...
            public boolean onQueryTextSubmit(String query) {
                ...
                mAdapter.swapCursor(myDBGeral.filtroOS(query, idColaborador));
