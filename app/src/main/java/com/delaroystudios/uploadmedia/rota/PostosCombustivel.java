...
public class PostosCombustivel extends AppCompatActivity implements BottomNavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        progressDialog.setMessage("Procurando os Postos de Combustivel mais proximos... ");
        ...
        webView.loadUrl("https://www.google.com.br/maps/search/postos+gasolina/@"+latitude+","+longitude+",13z/data=!3m1!4b1");
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.navigation_visitas) {
            ...
            Intent intent = new Intent(this, MainActivityVisitas.class);
            Bundle dados = new Bundle();
            dados.putString("name", name);
            dados.putString("email", email);
