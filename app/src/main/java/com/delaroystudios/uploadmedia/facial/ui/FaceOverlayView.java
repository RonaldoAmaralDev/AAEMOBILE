package com.delaroystudios.uploadmedia.facial.ui;
        ...
        if (mFaces != null && mFaces.length > 0) {
            ...
            for (FaceResult face : mFaces) {
                ...
                if (mid.x != 0.0f && mid.y != 0.0f) {
                    ...
                    canvas.drawText("Identificação: " + "rosto: " + face.getId(), rectF.left, rectF.bottom + mTextPaint.getTextSize(), mTextPaint);
                  //  canvas.drawText("Confidence: " + face.getConfidence(), rectF.left, rectF.bottom + mTextPaint.getTextSize() * 2, mTextPaint);
                    canvas.drawText("Distancia dos Olhos: " + face.eyesDistance(), rectF.left, rectF.bottom + mTextPaint.getTextSize() * 3, mTextPaint);
                }
            }
            canvas.restore();
        }
