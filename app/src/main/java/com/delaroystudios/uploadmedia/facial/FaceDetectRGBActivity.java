package com.delaroystudios.uploadmedia.facial;
...
import com.delaroystudios.uploadmedia.facial.adapter.ImagePreviewAdapter;
import com.delaroystudios.uploadmedia.facial.model.FaceResult;
import com.delaroystudios.uploadmedia.facial.ui.FaceOverlayView;
import com.delaroystudios.uploadmedia.facial.utils.CameraErrorCallback;
import com.delaroystudios.uploadmedia.facial.utils.ImageUtils;
import com.delaroystudios.uploadmedia.facial.utils.Util;
...
public class FaceDetectRGBActivity extends AppCompatActivity implements SurfaceHolder.Callback, Camera.PreviewCallback {
    ...
    public void onCreate(Bundle icicle) {
        ...
        setContentView(R.layout.activity_face_detect_rgb);
        ...
        getSupportActionBar().setTitle("Reconhecimento Facial");
        ...
        switch (item.getItemId()) {
            ...
            case R.id.switchCam:
                ...
                if (numberOfCameras == 1) {
                    ...
                    builder.setTitle("Trocar Camera").setMessage("Seu aparelho so possui uma camera").setNeutralButton("Fechar", null);
