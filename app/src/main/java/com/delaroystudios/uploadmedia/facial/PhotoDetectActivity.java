...
import com.delaroystudios.uploadmedia.facial.ui.FaceView;
...
public class PhotoDetectActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Detector Imagem");
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == PICK_IMAGE_REQUEST && resultCode == RESULT_OK && data != null && data.getData() != null) {
            ...
            if (bitmap != null)
                ...
                Toast.makeText(this, "Não foi possui abrir essa imagem.", Toast.LENGTH_LONG).show();
        }
    }
    ...
    public void getImage() {
        ...
        try {
            ...
            Toast.makeText(PhotoDetectActivity.this, "Seu aparelho não conseguiu selecionar a imagem.", Toast.LENGTH_LONG).show();
            finish();
        }
    }
