        ...
        btn_register.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (TextUtils.isEmpty(txt_username) || TextUtils.isEmpty(txt_email) || TextUtils.isEmpty(txt_password)){
                    ...
                    Toast.makeText(RegisterActivity.this, "Senha deve ter no minimo 6 caracteres", Toast.LENGTH_SHORT).show();
                } else {
                ...
                .addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()){
                            ...
                            Toast.makeText(RegisterActivity.this, "Não foi possivel registrar com esses dados.", Toast.LENGTH_SHORT).show();
                        }
                    }
                });
    }
