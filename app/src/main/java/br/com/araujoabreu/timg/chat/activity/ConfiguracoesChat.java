...
public class ConfiguracoesChat extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if ( url != null ){
            Glide.with(ConfiguracoesChat.this)
                    .load( url )
        ...
        imageAtualizarNome.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if ( retorno ){
                    ...
                    Toast.makeText(ConfiguracoesChat.this,
